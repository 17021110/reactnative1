...
import HeadderOutstandding from './HeadderOutstandding'
...
import Outstanding3 from './Outstanding3'
...
export default function OutstandingScience({ navigation, route }) {
    ...
    //             w='http://'+item
    //         }
    //         // else if(w!='http://lms-vnpt-sandbox.vnpt.edu.vn'){
    ...
    useEffect(() => {
        ...
        let link = "http://lms-vnpt-sandbox.vnpt.edu.vn/module/api/service/Course/getCourseDetail?id=";
